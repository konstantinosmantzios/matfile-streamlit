...
export const settingsGroupStyle = { display: 'flex', flexDirection: 'column', gap: 8, padding: '8px 0', borderBottom: '1px solid rgba(0,0,0,0.05)' };
export const settingsGroupTitleStyle = { fontSize: 11, fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', color: 'var(--text-muted)', userSelect: 'none' };
...
export const settingsInputBoxStyle = { display: 'flex', alignItems: 'center', backgroundColor: 'var(--bg-main)', border: '1px solid var(--border-color)', borderRadius: 8, padding: '2px 8px', transition: 'border-color 0.18s ease, box-shadow 0.18s ease' };
export const settingsInputStyle = { width: 54, border: 'none', background: 'transparent', color: 'var(--text-main)', fontSize: 12, outline: 'none', textAlign: 'center', padding: 0, appearance: 'textfield' };
export const settingsUnitStyle = { fontSize: 11, color: 'var(--text-muted)', marginLeft: 4 };
export const settingsSelectStyle = { padding: '5px 26px 5px 10px', borderRadius: 8, border: '1px solid var(--border-color)', backgroundColor: 'var(--bg-main)', color: 'var(--text-main)', fontSize: 12, outline: 'none', cursor: 'pointer', backgroundPosition: 'right 9px center' };
