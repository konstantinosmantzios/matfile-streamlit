  ...
  return (
    <div>
      ...
      {filterMethod === 'Savitzky-Golay' && (
        <>
          <div className="input-group" style={{ marginBottom: 12 }}>
            <label className="flex-between" style={{ marginBottom: 4 }}><span>Window Length</span><span>{settings[`${prefix}SavgolWin`]}</span></label>
          ...
          <div className="input-group" style={{ marginBottom: 12 }}>
            <label className="flex-between" style={{ marginBottom: 4 }}><span>Poly Order</span><span>{settings[`${prefix}SavgolPoly`]}</span></label>
      ...
      {filterMethod === 'Butterworth Low-Pass' && (
        <>
          <div className="input-group" style={{ marginBottom: 12 }}>
            <label className="flex-between" style={{ marginBottom: 4 }}><span>Cutoff (Hz)</span><span>{settings[`${prefix}ButterCutoff`]}</span></label>
          ...
          <div className="input-group" style={{ marginBottom: 12 }}>
            <label className="flex-between" style={{ marginBottom: 4 }}><span>Order</span><span>{settings[`${prefix}ButterOrder`]}</span></label>
      ...
      {filterMethod === 'Hampel' && (
        <>
          <div className="input-group" style={{ marginBottom: 12 }}>
            <label className="flex-between" style={{ marginBottom: 4 }}><span>Window Size</span><span>{settings[`${prefix}HampelWin`]}</span></label>
          ...
          <div className="input-group" style={{ marginBottom: 12 }}>
            <label className="flex-between" style={{ marginBottom: 4 }}><span>Sigma Threshold</span><span>{settings[`${prefix}HampelSig`]}</span></label>
